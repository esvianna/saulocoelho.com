    ...
    <div class="w-full lg:w-1/2 flex flex-col gap-6 z-10">
        ...
        <div class="mt-4 flex flew-wrap gap-4">
            <a href="#catalogo-slide" class="rounded-xl bg-primary px-8 py-3.5 font-black text-white shadow-[0_0_20px_-5px_rgba(0,186,255,0.4)] transition-all hover:-translate-y-1 hover:shadow-[0_0_25px_0_rgba(0,186,255,0.6)] uppercase tracking-widest text-xs flex items-center gap-2">
                Explorar Programas <span class="material-symbols-outlined text-[16px]">south</span>
            </a>
        </div>
    </div>
...
<div id="catalogo-slide" class="mt-32 mb-20 relative scroll-mt-24">
    <div class="flex items-center gap-4 mb-10 pt-4">
        <h2 class="text-2xl lg:text-3xl font-black text-white uppercase tracking-wider">A Jornada do Conhecimento</h2>
    ...
    <div class="relative group">
        ...
        <div class="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-12 pt-4 px-2 -mx-2 hide-scrollbar" style="scroll-behavior: smooth;">
            ...
            <div class="snap-start shrink-0 w-[280px] sm:w-[320px] flex flex-col items-center justify-center p-8 rounded-[2rem] border border-dashed border-white/20 bg-white/5 opacity-60 hover:opacity-100 transition-all">
                ...
                <h3 class="font-black text-lg text-white text-center">Mais Novidades em Breve</h3>
                <p class="text-xs text-slate-400 text-center mt-2">Nossas metodologias estão sempre evoluindo.</p>
            </div>
...
<div class="my-24 relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.02] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
    ...
    <div class="relative z-10 md:w-2/3">
        <div class="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full border border-white/10 text-[10px] font-black tracking-widest uppercase text-white mb-6">
            <span class="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse"></span> Atendimento Especializado
        </div>
        ...
        <p class="text-slate-400 font-light text-lg">
            Não tem certeza de qual programa é o ideal para o seu momento de carreira? Fale direto com um de nossos especialistas.
        </p>
    </div>
    
    <div class="relative z-10 md:w-1/3 flex justify-end">
        <a href="#contato" class="rounded-2xl px-8 py-5 bg-white text-background-dark font-black uppercase tracking-widest text-xs flex items-center gap-3 hover:bg-primary hover:text-white transition-all shadow-2xl hover:-translate-y-1 whitespace-nowrap">
            Falar com Consultor <span class="material-symbols-outlined">forum</span>
        </a>
    </div>
</div>
...
<div class="mt-24 rounded-3xl bg-zinc-950 p-12 text-center border border-white/5 relative overflow-hidden shadow-2xl">
    ...
    <h3 class="text-3xl md:text-4xl font-black text-white mb-4 relative z-10">Deseja impulsionar o seu time?</h3>
    <p class="text-slate-400 max-w-2xl mx-auto mb-10 font-light relative z-10">Oferecemos treinamentos in-company personalizados para as necessidades exclusivas e os desafios operacionais da sua empresa.</p>
    ...
    <div class="flex flex-wrap justify-center gap-6 relative z-10">
        <a href="#contato" class="rounded-xl bg-primary px-10 py-4 font-black text-white shadow-xl shadow-primary/20 transition-all hover:-translate-y-1 uppercase tracking-widest text-sm">
            Solicitar Orçamento In-company
        </a>
    </div>
</div>
