...
| D37 | **Avaliação Final Neuropsicanálise** (#12): no **vtis-quiz**; seed MC; `result_delivery` = **deferred**; timer 90 min; slug **`neuropsicanalise`**; prática 60/40 no admin; **`shuffle_options`** (embaralha A–D na tela). UI gabarito MC **fora**. **Não** regravar o quiz no admin (apaga opções MC). |
