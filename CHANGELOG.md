...
### Added
- Issue [#12](https://github.com/esvianna/saulocoelho.com/issues/12): Avaliação Final Neuropsicanálise — `vtis-quiz` **1.3.17**; slug **`neuropsicanalise`** (https://saulocoelho.com/quiz/neuropsicanalise/); D37 actualizado.
