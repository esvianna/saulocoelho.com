...
### Added
- Issue [#12](https://github.com/esvianna/saulocoelho.com/issues/12): Avaliação Final Neuropsicanálise — seed no plugin `vtis-quiz` **1.3.15** (`neuropsicanalise-final`, DB 8); D37 em `DECISIONS.md`. Deploy staging/prod pendente.
