...
### Added
- Issue [#12](https://github.com/esvianna/saulocoelho.com/issues/12): Avaliação Final Neuropsicanálise — `vtis-quiz` **1.3.20** (nota prática + certificação 60/40 no admin Leads); slug **`neuropsicanalise`**; D37 actualizado.
